          ...
          <div className="fixed top-0 bottom-0 left-0 z-50 w-3/4 overflow-y-auto bg-white p-4 lg:static lg:h-full lg:w-full lg:p-6">
            ...
            <div className="mt-6 flex flex-col gap-y-[0.563rem]">
              ...
              <NavItemCollapse
                ...
                setActiveNavName={setActiveNavName}
              >
                <Link to="/admin/posts/manage" className="font-semibold text-[#A5A5A5]">Manage all posts</Link>
                <button
                  disabled={isLoadingCreatePost}
                  className="text-start disabled:opacity-60 disabled:cursor-not-allowed font-semibold text-[#A5A5A5]"
                  onClick={() =>
                ...
                <Link to="/admin/categories/manage" className="font-semibold text-[#A5A5A5]">Categories</Link>
              </NavItemCollapse>
